...
function addQuestion() {
    ...
    if(!allOptions[allOptions.length-1] && type == 1){
        errors+="Option, "
    }
    let answer = null;
    let caseSensitive = 1;
    if(type==1){
        ...
        caseSensitive = $("#caseSensitive").is(":checked") ? 1 : 0;
        answer=$("#answer").val();
    }
    ...
    $.ajax({
        type: "post",
        url: "/coordinator/addQuestion/question",
        data: {
        ...
        success: function (response) {
            if (
                ...
                $.ajax({
                    type: "post",
                    url: "/coordinator/addQuestion/question/files",
                    data: formdata,
                    processData: false,
                    contentType: false,
                    success: function (response) {
...
$("#reset").on("click", function () {
    location.href = "/coordinator/addQuestion/question";
});
// TO ADD A NEW OPTION
